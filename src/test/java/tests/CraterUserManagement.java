...
import utilities.PropertiseReader;
	 ...
	 @Test
	  public void validLogin() throws InterruptedException {
		 ...
		 /*
		  ...
		  Driver.getDriver().get(PropertiseReader.getProperty("craterUrl"));
		  CraterLoginPage loginpage = new CraterLoginPage();
		  Thread.sleep(1000);
		  loginpage.useremail.sendKeys(PropertiseReader.getProperty("craterValidUserEmail"));
		  loginpage.password.sendKeys(PropertiseReader.getProperty("craterValidPassword"));
